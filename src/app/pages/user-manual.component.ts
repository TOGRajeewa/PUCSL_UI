  ...
  template: `
    <div class="min-h-screen bg-[#F4F6F8]">
      ...
      <main class="mx-[92px] mt-5 mb-24">
        <div class="bg-white rounded-lg shadow-custom px-72 py-22 flex flex-col items-center gap-8">
          <!-- Page Title -->
          <div class="flex flex-col items-center gap-2 mt-22">
            <h2 class="text-[32px] font-semibold font-['Poppins'] capitalize bg-gradient-to-r from-[#080114] to-[#290967] bg-clip-text text-transparent">
              System User Manual
            </h2>
            <p class="text-[#909090] text-lg font-normal font-['Poppins'] capitalize">
              Complete Guide for Submitters
            </p>
          </div>

          <!-- PDF Preview Area -->
          <div class="flex flex-col items-center gap-10 px-9 py-12 bg-[#F2F4F7] border border-dashed border-[#290967] rounded-lg w-full max-w-[1048px]">
            <!-- PDF Icon Display -->
            <div class="flex items-center justify-center px-11 py-12 bg-white rounded-lg rounded-tr-[104px]">
              <img 
            ...
            <div class="flex items-center gap-5">
              <button class="flex items-center gap-2.5 px-2.5 py-1.5 bg-[#290967] rounded h-10 min-w-[164px] justify-center">
                <span class="text-white text-base font-medium font-['Poppins'] capitalize">
                  View Online
                </span>
                <img 
              ...
              <button class="flex items-center gap-2.5 px-2.5 py-1.5 bg-[#12CEB0] rounded h-10 min-w-[164px] justify-center">
                <span class="text-white text-base font-medium font-['Poppins'] capitalize">
                  Download PDF
                </span>
                <img 
            ...
            <!-- Version Info -->
            <div class="flex justify-between items-center w-full max-w-[978px] px-46 py-3.5 bg-[rgba(41,9,103,0.04)] border border-[#290967] rounded-lg">
              <span class="text-[#080114] text-center text-lg font-light font-['Poppins'] capitalize">
                Updated: August 2025
              </span>
              <span class="text-[#080114] text-center text-lg font-light font-['Poppins'] capitalize">
                Version 2.1
