    ...
    <div class="min-h-screen bg-[#F4F6F8]">
      ...
      <main class="mx-[92px] mt-[85px] mb-24">
        <div class="bg-white rounded-lg shadow-custom px-10 py-18">
          <!-- Page Title -->
          <h2 class="text-center text-[32px] font-semibold font-['Poppins'] capitalize mb-16 bg-gradient-to-r from-[#390C90] to-[#290967] bg-clip-text text-transparent">
            Data Template Summary
          </h2>
