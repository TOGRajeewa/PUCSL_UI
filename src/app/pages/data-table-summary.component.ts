...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-[#F4F6F8]">
      ...
      <!-- Filter/Sort Bar -->
      <div
        class="flex justify-between items-center mx-5 mt-5 px-4 py-4 bg-white rounded-lg shadow-custom"
      >
        <button
          type="button"
          class="flex h-10 px-3 py-1.5 items-center gap-2.5 rounded bg-[#F0F0F0]"
        >
          <span
          ...
          <div class="flex flex-col gap-5">
            ...
            >
              ...
              <div class="flex flex-col gap-2">
                ...
                >
                  {{ item.subRef }} Schedule: {{ item.schedule }} Due:
                  {{ item.due }}
                </p>
                <div class="flex items-center gap-3">
                  <div
                  ...
                  >
                    <span
                      class="text-xs font-normal font-['Poppins'] capitalize"
              ...
              <div class="flex items-center gap-3">
                <button
                  class="flex w-36 h-8 px-2.5 py-1.5 justify-center items-center gap-2 rounded-lg bg-white"
                >
                  <span
                  ...
                  <img
                    src="https://api.builder.io/api/v1/image/assets/TEMP/5472228bb04ab304a3a93f096314ef5177b8f905?width=38"
                    alt=""
                    class="w-5 h-5"
                  />
                </button>
                ...
                >
                  ...
                  <img
                    src="https://api.builder.io/api/v1/image/assets/TEMP/efcde6b4e16499f6b431de8ed86ee02dc0110fb4?width=38"
                    alt=""
                    class="w-5 h-5"
                  />
                </button>
                ...
                >
                  ...
                  <img
                    src="https://api.builder.io/api/v1/image/assets/TEMP/e8abcc41aa5a9950b72172e59e2b22d4e335b683?width=38"
                    alt=""
                    class="w-5 h-5"
                  />
                </button>
