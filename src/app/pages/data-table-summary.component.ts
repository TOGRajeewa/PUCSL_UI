...
interface DataTableItem {
  ...
  schedule: string;
  due: string;
  tags: Array<{ label: string; color: string; borderColor: string; bgColor: string }>;
}
    ...
    <div class="min-h-screen bg-[#F4F6F8]">
      ...
      <header class="bg-white shadow-custom rounded-lg mx-5 mt-5 px-6 py-4">
        <div class="flex items-center justify-between">
          <h1 class="text-[#0B0B0B] text-base font-medium font-['Poppins'] capitalize">
            Data Table Summary
          </h1>

          <!-- Search Bar -->
          <div class="flex items-center gap-2 bg-[#F2F4F7] rounded px-3 py-2.5 w-[448px]">
            <svg class="w-4 h-4 fill-[#6C6C6C] opacity-95" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="flex items-center gap-3">
            ...
            <div class="flex items-center gap-4">
              <div class="relative">
                <svg class="w-5 h-6 fill-[#A9ABAD]" viewBox="0 0 19 25" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex items-center gap-3">
              ...
              />
              <div>
                <p class="text-[#0B0B0B] text-base font-normal font-['Poppins'] capitalize">
                  Naween tharuka
                </p>
                <p class="text-[#6C6C6C] opacity-95 text-xs font-light font-['Poppins'] capitalize">
                  Data Submitter
                </p>
              </div>
              <svg class="w-2.5 h-1.5 fill-[#6C6C6C] opacity-95" viewBox="0 0 10 5" xmlns="http://www.w3.org/2000/svg">
      ...
      <!-- Filter/Sort Bar -->
      <div class="flex justify-between items-center mx-5 mt-5 px-4 py-4 bg-white rounded-lg shadow-custom">
        <button type="button" class="flex h-10 px-3 py-1.5 items-center gap-2.5 rounded bg-[#F0F0F0]">
          <span class="text-[#434343] text-base font-medium font-['Poppins'] capitalize">Filters</span>
          <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M3 7.5H15M6 12H15M0 3H15" stroke="#6B7280" stroke-width="1.5" stroke-linecap="round"/>
          </svg>
        </button>
        <button type="button" class="flex h-10 px-3 py-1.5 items-center gap-2.5 rounded bg-[#F0F0F0]">
          <span class="text-[#434343] text-base font-medium font-['Poppins'] capitalize">Sort By</span>
          <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M3 7.5H15M6 12H15M0 3H15" stroke="#6B7280" stroke-width="1.5" stroke-linecap="round"/>
          </svg>
        </button>
      ...
      <!-- Main Content -->
      <main class="mx-[92px] mt-8 mb-24">
        <div class="bg-white rounded-lg shadow-custom px-8 py-8">
          <div class="flex flex-col gap-5">
            <div
              *ngFor="let item of items"
              class="flex justify-between items-center px-4 py-4 bg-[#F2F4F7] rounded-lg border-l-4 border-[#F35353]"
            >
              <!-- Left Section -->
              <div class="flex flex-col gap-2">
                <h3 class="text-[#232323] text-base font-medium font-['Poppins'] capitalize">
                  NM_{{ item.id }} ({{ item.name }})
                </h3>
                <p class="text-[#212121] text-sm font-normal font-['Poppins'] capitalize">
                  {{ item.subRef }}          Schedule: {{ item.schedule }}        Due: {{ item.due }}
                </p>
                <div class="flex items-center gap-3">
                  <div
                    *ngFor="let tag of item.tags"
                    class="flex px-2.5 py-1 justify-center items-center gap-2.5 rounded border"
                    [style.border-color]="tag.borderColor"
                    [style.background]="tag.bgColor"
                  >
                    <span class="text-xs font-normal font-['Poppins'] capitalize" [style.color]="tag.color">
                      {{ tag.label }}
                    </span>
                  </div>
                </div>
              ...
              <div class="flex items-center gap-3">
                <button class="flex w-36 h-8 px-2.5 py-1.5 justify-center items-center gap-2 rounded-lg bg-white">
                  <span class="text-[#080114] text-center text-sm font-normal font-['Poppins'] capitalize">
                    Manual
                  </span>
                  <img src="https://api.builder.io/api/v1/image/assets/TEMP/5472228bb04ab304a3a93f096314ef5177b8f905?width=38" alt="" class="w-5 h-5" />
                </button>
                <button class="flex w-36 h-8 px-2.5 py-1.5 justify-center items-center gap-2 rounded-lg bg-white">
                  <span class="text-[#080114] text-center text-sm font-normal font-['Poppins'] capitalize">
                    History
                  </span>
                  <img src="https://api.builder.io/api/v1/image/assets/TEMP/efcde6b4e16499f6b431de8ed86ee02dc0110fb4?width=38" alt="" class="w-5 h-5" />
                </button>
                <button class="flex w-36 h-8 px-2.5 py-1.5 justify-center items-center gap-2 rounded-lg bg-white">
                  <span class="text-[#080114] text-center text-sm font-normal font-['Poppins'] capitalize">
                    Download
                  </span>
                  <img src="https://api.builder.io/api/v1/image/assets/TEMP/e8abcc41aa5a9950b72172e59e2b22d4e335b683?width=38" alt="" class="w-5 h-5" />
                </button>
              </div>
            </div>
          </div>
  ...
  items: DataTableItem[] = [
    {
      ...
      due: '2024 - 07 -05',
      tags: [
        { label: 'Energy', color: '#F35353', borderColor: '#F35353', bgColor: 'linear-gradient(0deg, rgba(243, 83, 83, 0.10) 0%, rgba(243, 83, 83, 0.10) 100%), #FFF' },
        { label: 'Operational', color: '#128ECE', borderColor: '#128ECE', bgColor: 'linear-gradient(0deg, rgba(18, 142, 206, 0.10) 0%, rgba(18, 142, 206, 0.10) 100%), #FFF' },
        { label: 'Electricity', color: '#12CEB0', borderColor: '#12CEB0', bgColor: 'linear-gradient(0deg, rgba(18, 206, 176, 0.10) 0%, rgba(18, 206, 176, 0.10) 100%), #FFF' }
      ]
    },
    {
      id: '202406',
